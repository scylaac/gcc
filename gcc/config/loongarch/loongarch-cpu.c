...
struct loongarch_cpu_config loongarch_cpu_default_config[] = {
  /* CPU_NATIVE */      { -1, -1, -1, -1, -1 },
  /* CPU_LOONGARCH64 */ { ISA_LA64, ABI_LP64, ISA_DOUBLE_FLOAT, ABI_DOUBLE_FLOAT, 0 },
  /* CPU_GS464V */      { ISA_LA64, ABI_LP64, ISA_DOUBLE_FLOAT, ABI_DOUBLE_FLOAT, 0 },
};
